...
Recentemente escrevi [uma saga de 6 artigos](https://dev.to/leandronsp/series/27062) sobre Assembly x86, abordando conceitos fundamentais de arquitetura de computadores e programação low-level enquanto ia desenvolvendo um web server minimalista multi-threaded.
...
Como vimos [na parte IV](https://dev.to/leandronsp/construindo-um-web-server-em-assembly-x86-parte-iv-um-assembly-modesto-oif) da saga, a memória é organizada de forma contígua, onde as informações são alocadas uma após a outra.
